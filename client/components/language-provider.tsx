...
const translations = {
  en: {
    ...
    notification_reposts: 'and others reposted your post',
  ...
  vi: {
    ...
    notification_reposts: 'và những người khác đã chia sẻ lại bài viết của bạn',
  ...
  ja: {
    ...
    notification_reposts: 'あなたの投稿を他の人がリポストしました',
